...
#run this script to stop the motor from receiving voltage after aborting other scripts
# if GPIO.cleanup() does not run successfully the motor will heat up even after the script is closed

#print("reset and stop motor")
